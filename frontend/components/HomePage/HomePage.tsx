...
const AnimatedBackground = () => (
  <div className="fixed inset-0 -z-10 overflow-hidden">
    ...
    >
      <div className="absolute inset-0 bg-linear-radial from-neon-cyan/20 via-neon-cyan/5 to-transparent blur-3xl" />
    </motion.div>
          ...
          {initialLoading && (
            ...
            >
              <div className="flex flex-col items-center space-y-6">
                ...
                <motion.p
                  className="text-lg font-medium bg-linear-to-r from-primary-400 via-neon-blue to-neon-cyan bg-clip-text text-transparent"

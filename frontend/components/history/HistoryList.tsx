...
export default function HistoryList({
    ...
    return (
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-16 text-center border border-purple-100 dark:border-purple-900">
        <div className="max-w-md mx-auto">
          <div className="mb-6">
            <div className="mx-auto w-20 h-20 bg-linear-to-br from-purple-100 to-pink-100 dark:from-purple-900/30 dark:to-pink-900/30 rounded-full flex items-center justify-center">
              <svg
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Pagination Controls */}
      {total_pages > 1 && (
        <div className="bg-linear-to-r from-white to-purple-50 dark:from-gray-800 dark:to-purple-900/20 rounded-xl shadow-lg p-6 border border-purple-100 dark:border-purple-900">

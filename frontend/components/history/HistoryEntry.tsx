...
export default function HistoryEntry({ entry, index = 0, onDelete }: HistoryEntryProps) {
  ...
  return (
    ...
    >
      ...
      <div className={`absolute left-3.5 top-0 bottom-0 w-0.5 bg-linear-to-b ${badge.timelineColor} to-transparent`} />
      ...
      >
        ...
        <div className={`h-1 bg-linear-to-r ${badge.timelineColor} to-transparent`} />
      </motion.div>
    </motion.div>
  );
}

...
const commonConfig = {
  ...
  customClass: {
    ...
    title: 'text-2xl font-bold bg-linear-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent',
    htmlContainer: 'text-gray-600',
    confirmButton: 'bg-linear-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold py-3 px-6 rounded-xl shadow-md hover:shadow-lg transition-all',

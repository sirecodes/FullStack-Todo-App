...
export function AnimatedNeonBackground({
  ...
  return (
    <div className="absolute inset-0 -z-10 overflow-hidden">
      ...
      >
        <div className="absolute inset-0 bg-linear-radial from-primary-500/60 via-primary-500/25 to-transparent blur-3xl" />
      </motion.div>
      ...
      >
        <div className="absolute inset-0 bg-linear-radial from-neon-cyan/60 via-neon-cyan/25 to-transparent blur-3xl" />
      </motion.div>
      ...
      >
        <div className="absolute inset-0 bg-linear-radial from-neon-blue/55 via-neon-blue/20 to-transparent blur-3xl" />
      </motion.div>
      ...
      >
        <div className="absolute inset-0 bg-linear-radial from-neon-green/50 via-neon-green/20 to-transparent blur-3xl" />
      </motion.div>
      ...
      >
        <div className="absolute inset-0 bg-linear-radial from-neon-pink/45 via-neon-pink/15 to-transparent blur-3xl" />
      </motion.div>
      ...
      >
        <div className="absolute inset-0 bg-linear-radial from-neon-yellow/40 via-neon-yellow/15 to-transparent blur-3xl" />
      </motion.div>

...
const AnimatedBackground = () => (
  <div className="absolute inset-0 -z-10 overflow-hidden">
    ...
    >
      <div className="absolute inset-0 bg-linear-radial from-neon-red/40 via-neon-red/10 to-transparent blur-3xl" />
    </motion.div>
        ...
        <GlassCard variant="elevated" className="p-8 md:p-12 text-center">
          ...
          >
            <h1 className="text-8xl md:text-9xl font-bold mb-4">
              <span className="bg-linear-to-r from-neon-red via-primary-400 to-neon-pink bg-clip-text text-transparent drop-shadow-[0_0_30px_rgba(239,68,68,0.5)]">
                404
              </span>
            </h1>
          </motion.div>
